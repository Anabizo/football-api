...
export default function PartidasId() {
    ...
    const { data: partidas, isLoading: isLoadingPartidas, isError: isErrorPartidas } = useQuery<PartidaId | null>(
        ['partidasId', id],
        () => fetchPartidasId(id),
        {
            enabled: !!id,
    ...
    return (
        <div className="flex justify-center items-center min-h-screen bg-purple-400">
            <div className="bg-gray-700 text-white rounded-3xl py-16 px-10 w-11/12 max-w-2xl shadow-lg">
